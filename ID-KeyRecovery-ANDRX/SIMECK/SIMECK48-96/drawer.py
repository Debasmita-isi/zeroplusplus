...
def parse_command_line():
    ...
    parser.add_argument('-RB', default=5, type=int, help='The number of rounds for EB')
    parser.add_argument('-RD', default=11, type=int, help='The number of rounds for ED')
    parser.add_argument('-RF', default=4, type=int, help='The number of rounds for EF')
    parser.add_argument('-bs', default=32, type=int, help='The block size')
    parser.add_argument('-o', default="simeck32-64-20r.tex", type=str, help='The output file')
...
if __name__ == '__main__':
    ...
    draw.genrate_attack_shape_2files()
