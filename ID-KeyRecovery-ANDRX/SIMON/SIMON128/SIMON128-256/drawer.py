...
def parse_command_line():
    ...
    parser.add_argument('-RD', default=19, type=int, help='The number of rounds for ED')
    parser.add_argument('-MD', default=7, type=int, help='The number of rounds for ED')
    parser.add_argument('-RF', default=6, type=int, help='The number of rounds for EF')
