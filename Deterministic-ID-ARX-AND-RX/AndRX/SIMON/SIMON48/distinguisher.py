...
def main():
  ...
  parser.add_argument("-variant", type=int, default=48, help="The variant of SIMON")
  parser.add_argument("-block-size", type=int, default=48, help="The block size of SIMON")
