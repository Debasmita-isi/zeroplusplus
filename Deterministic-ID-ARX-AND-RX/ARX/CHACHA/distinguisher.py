...
def parse_command_line():
    '''
        ...
        '''
    parser = argparse.ArgumentParser(description="Impossible distinguisher for ChaCha.")
    parser.add_argument('-RD', default=5, type=int, help='The number of rounds for ED')
