...
def parse_command_line():
    '''
        ...
        '''
    parser = argparse.ArgumentParser(description="Impossible distinguisher for LEA.")
    parser.add_argument('-RD', default=10, type=int, help='The number of rounds for ED')
